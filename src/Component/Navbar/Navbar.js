    ...
    return (
            <nav className="navbar">
                ...
                <div className="desktopMenu">
                    ...
                    <Link activeClass='active' to='skils' spy={true} smooth={true} offset={-75} duration={500} className='desktopMenuListItem'>About</Link>
                ...
                <div className="navMenu" style={{display: showMenu? 'flex':'none'}}>
                    ...
                    <Link activeClass='active' to='skils' spy={true} smooth={true} offset={-50} duration={500} className='listItem' onClick={()=> setShowMenu(false)}>About</Link>
